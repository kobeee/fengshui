# Level 9 - 暖色终图提示词 (v3.0 - Nano Banana Pro Optimized)
...
1. Bed MOVED to flat ceiling area (position changed)
2. CURTAIN installed on skylight
3. SALT LAMP placed in dark corner glowing warm orange
4. Room tidied and organized
5. Cozy warm atmosphere
...
2. ATMOSPHERE TRANSFORMATION:
   - Shift from "cold damp evening" to "cold damp evening"
   - Color palette: Cool blues/greys → Warm yellows, soft oranges, gentle browns, cream whites
   - Lighting: Dim with harsh skylight → Soft filtered light with warm glow
