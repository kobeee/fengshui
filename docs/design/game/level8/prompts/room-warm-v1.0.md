# Level 8 - 暖色终图提示词 (v3.0 - Nano Banana Pro Optimized)
...
1. SCREEN placed to block door clash
2. GOURD tied to kitchen beam
3. PLANT placed for balance
4. Kitchen counters cleaned and organized
5. Dishes put away
6. Warm sunset glow through windows
...
2. ATMOSPHERE TRANSFORMATION:
   - Shift from "cold modern evening" to "cold modern evening"
   - Color palette: Cool blues/greys → Warm yellows, soft oranges, gentle browns, cream whites
   - Lighting: Harsh artificial light → Golden sunset glow
