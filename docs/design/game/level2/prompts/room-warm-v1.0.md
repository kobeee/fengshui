# Level 2 - 暖色终图提示词 (v3.0 - Nano Banana Pro Optimized)
...
1. The mirror has been ROTATED to face AWAY from the bed - NO reflection of bed visible
2. Room is tidier - cat toys organized in basket
3. Warmer afternoon light through window
...
2. ATMOSPHERE TRANSFORMATION:
   - Shift from "gloomy but warm-hearted cat lover" to "cozy happy cat paradise"
   - Color palette: Cool blues/greys → Warm yellows, soft oranges, gentle browns, cream whites
   - Lighting: Overcast grey afternoon → Golden hour warm sunlight
