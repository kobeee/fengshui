# Level 12 - 暖色终图提示词 (v3.0 - Nano Banana Pro Optimized)
...
1. DRAGON TURTLE on desk behind chair
2. PLANT between pillar and desk
3. COPPER GOURD near cable area
4. MONEY TOAD in wealth corner with clean space
5. Cables organized and tidied
6. Desk cleaned and organized
...
2. ATMOSPHERE TRANSFORMATION:
   - Shift from "busy tech chaos" to "busy tech chaos"
   - Color palette: Cool blues/greys → Warm yellows, soft oranges, gentle browns, cream whites
   - Lighting: Fluorescent harsh → Warm comfortable office
