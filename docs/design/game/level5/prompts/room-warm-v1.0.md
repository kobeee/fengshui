# Level 5 - 暖色终图提示词 (v3.0 - Nano Banana Pro Optimized)
...
1. GOURD tied to ceiling beam with red cord
2. BROAD-LEAF PLANT placed between sharp corner and bed
3. RGB lighting toned down to warm ambient
4. Floor cleared of snack wrappers, peripherals organized
5. Morning sunlight instead of dark night
...
2. ATMOSPHERE TRANSFORMATION:
   - Shift from "late night gaming session" to "balanced gaming lifestyle"
   - Color palette: Cool blues/greys → Warm yellows, soft oranges, gentle browns, cream whites
   - Lighting: Dark with RGB glow → Natural morning sunlight
