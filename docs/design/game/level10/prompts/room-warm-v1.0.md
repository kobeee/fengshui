# Level 10 - 暖色终图提示词 (v3.0 - Nano Banana Pro Optimized)
...
2. CURTAIN hung on bathroom door
3. SALT LAMP placed in dark corner
4. Room made tidy and comfortable for elderly
5. Warm, healthy atmosphere
...
2. ATMOSPHERE TRANSFORMATION:
   - Shift from "cold lonely evening" to "cold lonely evening"
   - Color palette: Cool blues/greys → Warm yellows, soft oranges, gentle browns, cream whites
   - Lighting: Dim lonely evening → Warm comfortable evening
