# Level 20 - 暖色终图提示词 (v3.0 - Nano Banana Pro Optimized)
...
3. SHAN HAI ZHEN on wall
4. STONE TABLET near entrance
5. PLANTS at sharp corners and buffers
6. SCREEN between door and window
7. MONEY TOAD in wealth corner
8. SALT LAMP in dark corner
9. Room completely organized and harmonious
10. Perfectly balanced warm harmonious atmosphere - ultimate feng shui success
...
2. ATMOSPHERE TRANSFORMATION:
   - Shift from "chaotic imbalanced" to "chaotic imbalanced"
   - Color palette: Cool blues/greys → Warm yellows, soft oranges, gentle browns, cream whites
   - Lighting: Extremely oppressive → Perfectly balanced harmonious
...
OUTPUT: Single 2.5:1 warm isometric pixel art image showing the harmonized room.
```
